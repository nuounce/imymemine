...
export const STAGE_WHISPERS: Record<string, StageWhisper> = {
  ...
  '02_I': {
    ...
    steps: [
      '뛰어봤어. 닫히기 전엔 못 와.',
      '아, 순서를 바꾸면 되잖아. 문 앞에 내가 먼저 가 있고, 버튼은 다른 내가 누르고.',
      '버튼 누르고 R. 발판이 아니어도 되는 거네.',
    ],
  },
  '03_I': {
  ...
  '04_I': {
    ...
    steps: [
      ...
      '순서가 문제네. 바깥 발판에서 R, 안쪽에서 또 R, 마지막에 내가 지나간다.',
    ],
  },
  ...
  '05_MY': {
    ...
    steps: [
      ...
      '저 간수, 귀가 밝네. 소리만 나면 바로 그쪽으로 간다.',
      '한쪽에서 누가 시끄럽게 뛰면 반대쪽은 비겠지.',
      '버튼은 잠깐만 열어 줘. 눌리는 순간 내가 이미 문 앞이어야 해.',
      '하나는 남쪽에서 뛰다 발판으로, 하나는 버튼으로. 지나가는 건 지금 나고.',
    ],
  },
  '06_MY': {
    ...
    steps: [
      ...
      '소리는 다른 나한테 맡기자. 쟤가 그쪽에 붙어 있는 동안 내가 지나가면 되고.',
    ],
  },
  '07_MY': {
  ...
  '10_ME': {
    ...
    steps: [
      ...
      '나도 저쪽 나도, 각자 빛 꺼질 때 맞춰서 건너면 되는 거잖아.',
    ],
  },
  '11_ME': {
  ...
  '13_MINE': {
    ...
    steps: [
      ...
      '감시등부터 끄고 건넌다. 문은 그다음.',
      '발판 셋이 같이 눌리는 순간 전기가 문으로 넘어간다. 그 순간엔 감시등 앞에 있으면 안 된다.',
    ],
  },
  '14_MINE': {
