...
export const STAGE_WHISPERS: Record<string, StageWhisper> = {
  ...
  '06_MY': {
    opening: '저 놈은 코가 밝아 보이는데. 발밑은 하필 울리는 바닥이고.',
    steps: [
      '한번 걸리면 안 놓을 것 같은데, 저건. 뛰어서 될 게 아니야.',
  ...
  '12_ME': {
    ...
    steps: [
      ...
      '남쪽 개는 누가 붙들어 놔야 해. 오래 무는 만큼 오래 비니까.',
  ...
  '13_MINE': {
    ...
    steps: [
      '금고 안은 위아래로 하나씩 물고 있네. 가운데 줄만 비었고.',
